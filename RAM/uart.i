...
void UART_Transmit(volatile UART_TX *uart_tx)
{
 ...
 while (uart_tx->curPos < uart_tx->emptyPos && time_out > 0)
 {
  ...
  if (time_out > 0)
  {
   ((USART_TypeDef *) (0x40000000U + 0x4800U))->DR = (uint8_t)uart_tx->queue[uart_tx->curPos];


   uart_tx->curPos += 1;
   if (uart_tx->curPos >= uart_tx->emptyPos)
   {
    uart_tx->curPos = 0;
    uart_tx->emptyPos = 0;
   }
...
void UART3_Configure(void)
{
 ...
 ((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0400U))->MODER |= ((0b10 << (22U)) | (0b10 << (20U)));
 ...
 ((USART_TypeDef *) (0x40000000U + 0x4800U))->CR1 |= (1 << (9U));
 ...
 ((USART_TypeDef *) (0x40000000U + 0x4800U))->BRR &= ~((0xFFFU << (4U)) | (0xFU << (0U)));
