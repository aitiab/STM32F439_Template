...
volatile Outputs outputs = {0U, 0U, 1U, 0U};
...
# 126 "src/main.c"
  ...
  if (CONTROL_MODE_FLAG & (1 << (0U)))
  {

   if ((TIM7_RUNNING_FLAG & (1 << (1U))) == 0)
   {
    outputs.Fan = 1;
   }


   if (HMS_Poll_Fan_Switch(&(outputs.Fan), 0) == 1)
   {
    if (outputs.Fan == 0)
    {
...
void USART3_IRQHandler(void)
{
 ...
 if (((USART_TypeDef *) (0x40000000U + 0x4800U))->SR & (0x1U << (4U)))
 {
  ...
  (void)((USART_TypeDef *) (0x40000000U + 0x4800U))->DR;
  if (uart_rx.state == 1)
  {
   uart_rx.state = 2;
   COMM_FLAG |= (1 << (1U));
...
void TIM7_IRQHandler(void)
{
 if ((((TIM_TypeDef *) (0x40000000U + 0x1400U))->SR & (0x1U << (0U))) != 0)
 {
  ...
  if (TIM7_RUNNING_FLAG & (1 << (1U)))
  {
   outputs.Fan = 1;
  }
  TIM7_RUNNING_FLAG &= 0x00;
  if (CONTROL_MODE_FLAG & (1 << (1U)))
  {
   CONTROL_MODE_FLAG = ((1 << (0U)));
  }
 }
}
# 238 "src/main.c"
