...
void ASCII_Extract(volatile float *t_Val, volatile char t_ASCII[])
{
 ...
 uint8_t twoDigits = (uint8_t)temporary;

 t_ASCII[1] = ((twoDigits / 10) + '0');
 t_ASCII[2] = ((twoDigits % 10) + '0');

 float temp = temporary - twoDigits;
 uint8_t twoLastDigits = (uint8_t)(temp * 100);
